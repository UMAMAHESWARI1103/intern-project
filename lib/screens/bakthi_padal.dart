...
final List<Song> _allSongs = [
  const Song(
    ...
    audioUrl:
        'https://archive.org/download/hemanth_gundubogula/VenkatesaSuprabhatam.mp3',
    lyrics:
  ...
  const Song(
    ...
    audioUrl:
        'https://archive.org/download/hemanth_gundubogula/Jagatini.mp3',
    lyrics:
        'Kaithal saevadi potri\nKarunaikkadal potri\nMurugarasane potri\nVel vel muruga vel\n\nSakti vel muruga vel\nKandha vel muruga vel\nAaru mugan potri potri',
  ),
  const Song(
    id: 's4',
    ...
    icon: Icons.waves,
    audioUrl:
        'https://archive.org/download/HanumanSongsListenOnTuesday/Hanuman-Chalisa-AnupJalota.mp3',
    lyrics:
  ...
  const Song(
    ...
    language: 'Sanskrit',
    deity: 'Devi',
    cardColor: Color(0xFFAD1457),
    icon: Icons.auto_awesome,
    // Fixed: added .mp3 extension
    audioUrl:
        'https://archive.org/download/hemanth_gundubogula/Kaliamma.mp3',
    lyrics:
  ...
  const Song(
    ...
    audioUrl:
        'https://archive.org/download/hemanth_gundubogula/Lord%20Shiva%20Rudra%20Mantra%20-%20Om%20Sivoham%20Rudra%20Naamam%20Bajeham.mp3',
    lyrics:
  ...
  const Song(
    ...
    icon: Icons.favorite,
    audioUrl:
        'https://archive.org/download/hemanth_gundubogula/Durga%20Chalisa.mp3',
    lyrics:
  ...
  const Song(
    ...
    icon: Icons.wb_sunny,
    audioUrl:
        'https://archive.org/download/HinduGodSongs/Gayatri%20Mantra.mp3',
    lyrics:
  ...
  const Song(
    ...
    icon: Icons.star,
    audioUrl:
        'https://archive.org/download/HanumanSongsListenOnTuesday/Hanuman-Chalisa-MSRR.mp3',
    lyrics:
...
class _BakthiPadalPageState extends State<BakthiPadalPage>
  ...
  void initState() {
    ...
    // FIX: Set release mode so audio doesn't get released between songs
    ...
    _player.onPlayerStateChanged.listen((state) {
      ...
      setState(() {
        ...
        // Clear loading once playing starts
    ...
    _player.onPlayerComplete.listen((_) {
      ...
      if (idx >= 0 && idx < _allSongs.length - 1) {
  ...
  // FIX: Use setSourceUrl + resume instead of play(UrlSource(...))
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Could not play "${song.title}". Please check your connection.'),
          ...
          child: Column(children: [
            ...
            Padding(
              ...
              child: Row(children: [
                Container(
                    ...
                    child:
                        Icon(song.icon, color: Colors.white, size: 28)),
            ...
            Expanded(
                child: ListView(
                  ...
                  Text(song.lyrics,
                      style: const TextStyle(
                          color: _textDark, fontSize: 16, height: 2.0)),
              ...
              SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return GestureDetector(
                        onTap: () =>
                            setState(() => _selectedDeity = _deities[i]),
                        child: AnimatedContainer(
                          duration: const Duration(milliseconds: 200),
                          margin: const EdgeInsets.only(right: 8),
                          padding: const EdgeInsets.symmetric(
        ...
        Expanded(
          child: ListView.builder(
            padding: EdgeInsets.fromLTRB(
                16, 12, 16, _currentSong != null ? 150 : 16),
            ...
            itemBuilder: (_, i) {
              ...
              final isThisLoading =
                  _currentSong?.id == song.id && _isLoading;
                  ...
                  child: Row(children: [
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          // FIX: Show loading spinner when buffering
                          Container(
                            width: 34,
                            height: 34,
                            decoration: BoxDecoration(
                                color:
                                    isCurrent ? _primary : _accent,
                                shape: BoxShape.circle),
                            child: isThisLoading
                                ? const Padding(
              ...
              SliderTheme(
                ...
                child: Slider(
                  ...
                  onChanged: (v) async {
                    final pos = Duration(
                        milliseconds:
                            (_duration.inMilliseconds * v).toInt());
              ...
              Padding(
                ...
                child: Row(children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      final idx = _allSongs
                          .indexWhere((s) => s.id == _currentSong!.id);
                      if (idx > 0) _playSong(_allSongs[idx - 1]);
                    },
                  ),
                  // FIX: Show loading spinner in now-playing bar too
                  GestureDetector(
