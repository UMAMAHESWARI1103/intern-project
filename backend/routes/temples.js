...
function checkOpen(openTime, closeTime) {
  ...
  return hour >= parseHour(openTime) && hour < parseHour(closeTime);
}

// ─────────────────────────────────────────
// 50+ MAJOR TAMIL NADU TEMPLES
// image_url: direct Wikipedia thumbnail URLs (load reliably in mobile apps)
// ─────────────────────────────────────────
function getFallbackTemples() {
  return [
    ...
    // ══ ARUPADAI VEEDU — Six Abodes of Lord Murugan ══════════════════════
    {
      ...
      open_time: '6:00 AM', close_time: '8:00 PM',
    ...
    },
    {
      ...
      description: 'One of the six abodes of Lord Murugan, uniquely located on the seashore of the Bay of Bengal. The only Arupadai Veedu on the coast. Lord Murugan is believed to have defeated Soorapadman near this shore.',
      ...
      open_time: '5:00 AM', close_time: '9:00 PM',
    ...
    },
    {
      ...
      description: 'One of the six abodes of Lord Murugan. Murugan is worshipped as a Guru here — he is believed to have taught the Pranava Mantra to his own father Lord Shiva. Reached by climbing 60 steps.',
    ...
    },
    {
      ...
      description: 'One of the six abodes of Lord Murugan. Situated on a hill of 365 steps — one for each day of the year. Believed to be where Murugan rested and married Valli after his victory over Soorapadman.',
      ...
      open_time: '6:00 AM', close_time: '8:30 PM',
    ...
    },
    {
      ...
      description: 'One of the six abodes of Lord Murugan, nestled in the lush Alagar Hills near Madurai. Surrounded by dense forests with a stream. Also called Alagar Koil. The Chithirai festival here draws lakhs of pilgrims.',
      image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bf/Azhagar_Temple.jpg/480px-Azhagar_Temple.jpg',
      open_time: '6:00 AM', close_time: '7:00 PM',
      festivals: ['Vaikasi Visakam', 'Panguni Uthiram', 'Chithirai Festival'],
      lat: 9.9968, lon: 78.2362,
    },

    // ══ PANCHA BHUTA STALAS — Five elements of Shiva ═════════════════════
    {
      id: 1006,
      name: 'Nataraja Temple, Chidambaram',
      location: 'Chidambaram, Cuddalore, Tamil Nadu',
      deity: 'Lord Nataraja (Shiva — Space element)',
      description: 'One of the Pancha Bhuta Stalas representing space (Akasha). Lord Shiva performed his cosmic Ananda Tandava dance here. A sacred Chola-period temple covering 40 acres with four towering gopurams.',
    ...
    },
    {
      ...
      description: 'One of the Pancha Bhuta Stalas representing earth (Prithvi). Has a famous mango tree over 3500 years old with four branches representing the four Vedas. The 58-metre tall gopuram is one of the tallest in South India.',
    ...
    },
    {
      ...
      description: 'One of the Pancha Bhuta Stalas representing fire (Agni). Shiva is worshipped as a column of fire. The sacred Karthigai Deepam lamp is lit on top of Arunachala Hill every year, visible from 30 km away.',
      ...
      open_time: '5:30 AM', close_time: '9:00 PM',
    ...
    },
    {
      ...
      description: 'One of the Pancha Bhuta Stalas representing water (Appu). The Shiva lingam here is submerged in a natural spring inside the sanctum. A perennial water source has existed inside this temple for centuries.',
    ...
    },
    {
      ...
      description: 'One of the Pancha Bhuta Stalas representing air (Vayu). The flame in the sanctum flickers as if moved by wind even though there is no physical breeze. A major pilgrimage center on the banks of the Swarnamukhi river.',
    ...
    // ══ FAMOUS SHIVA TEMPLES ══════════════════════════════════════════════
    {
      ...
      description: 'UNESCO World Heritage Site built by Raja Raja Chola I in 1010 CE. The 66-metre vimana (tower) was the tallest in the world when built. The shadow of the main tower never falls on the ground — a remarkable architectural feat.',
    ...
    },
    {
      ...
      description: 'One of the twelve sacred Jyotirlinga temples. Has the longest corridor (1.2 km) among all Hindu temples in India with 1212 majestic pillars. Located on Pamban Island — one of the four sacred Dhams.',
    ...
    },
    {
      ...
      description: 'A famous Dravidian temple in Mylapore, one of the oldest parts of Chennai. The magnificent colorful gopuram rises 37 metres. Saint Gnanasambandar composed hymns here. The temple tank is a city landmark.',
      ...
      open_time: '5:00 AM', close_time: '9:30 PM',
    ...
    },
    {
      ...
      description: 'A twin temple complex built by Pandya kings. Famous worldwide for its musical pillars — each pillar produces a distinct musical note when tapped. The temple complex covers a vast area with intricate carvings.',
    ...
    },
    {
      ...
      description: 'Lord Shiva is worshipped as Vaidyanatha — the God of healing. The temple tank water (Siddhamirtham) is believed to cure diseases. Nadi astrology (palm leaf reading) is widely practiced near this temple.',
    ...
    },
    {
      ...
      description: 'UNESCO World Heritage Site — part of the Great Living Chola Temples. Built by Rajaraja Chola II in the 12th century. Known for its unique musical steps (Saptaswaras) and extraordinarily detailed miniature carvings.',
    ...
    },
    {
      ...
      description: 'Ancient sacred temple where Lord Shiva performed the cosmic Ananda Tandava dance. The Akasha Lingam (formless space) is worshipped here. The Chidambara Rahasya (secret of Chidambaram) is a profound spiritual mystery.',
      image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/Chidambaram_temple.jpg/480px-Chidambaram_temple.jpg',
      open_time: '6:00 AM', close_time: '8:30 PM',
    ...
    },
    {
      ...
      description: 'A uniquely rare temple where the Hindu Trinity — Shiva, Vishnu and Brahma — are worshipped together as one. Famous for its 40-metre gopuram, musical pillars, and a magnificent 6-metre Hanuman statue.',
      ...
      open_time: '5:00 AM', close_time: '8:30 PM',
    ...
    },
    {
      ...
      description: 'Known as the Kashi of the South. Located at the base of the Western Ghats with the Courtallam waterfall nearby. The temple architecture resembles Varanasi\'s Kashi Vishwanath. Lord Shiva is worshipped here as Viswanathar.',
    ...
    },
    {
      ...
      deity: 'Lord Shiva (Brihadeeswara)',
      description: 'UNESCO World Heritage Site — built by Rajendra Chola I in 1035 CE to commemorate his conquest up to the Ganges river. The Gangaikondan Shivakami Amman shrine is renowned for its exquisite sculpture.',
    ...
    // ══ FAMOUS VISHNU / PERUMAL TEMPLES ══════════════════════════════════
    {
      ...
      description: 'The largest functioning Hindu temple in the world, covering 156 acres with 21 gopurams. Lord Vishnu reclines on the serpent Adi Shesha. It has 7 concentric enclosures (prakarams) and is a complete township within itself.',
      ...
      open_time: '6:00 AM', close_time: '9:00 PM',
    ...
    },
    {
      ...
      description: 'One of the 108 Divya Desams. Famous for its magnificent 100-pillar mandapam with intricate Vijayanagara-era sculptures. A golden lizard and silver lizard idol on the roof are said to grant liberation when touched.',
      ...
      open_time: '7:00 AM', close_time: '8:00 PM',
    ...
    },
    {
      ...
      deity: 'Lord Krishna (Parthasarathy — Arjuna\'s Charioteer)',
      description: 'One of the 108 Divya Desams built by Pallava kings in the 8th century. One of the oldest temples in Chennai. Lord Krishna is worshipped in his form as the charioteer of Arjuna in the Mahabharata war.',
      ...
      open_time: '7:00 AM', close_time: '8:30 PM',
    ...
    },
    {
      ...
      description: 'An ancient powerful Kali temple adjacent to the famous Nataraja temple in Chidambaram. Goddess Kali is worshipped here as the protector of the town. One of the most important Shakti shrines in the Cauvery delta region.',
    ...
    },
    {
      ...
      description: 'One of the 108 Divya Desams on the banks of the Cauvery. Famous as the temple where no salt is used in the food offered to the deity. Lord Vishnu married Goddess Bhumi Devi here in a unique legend.',
    ...
    // ══ FAMOUS AMMAN / SHAKTI TEMPLES ════════════════════════════════════
    {
      ...
      description: 'One of the largest Hindu temples in the world, dedicated to Goddess Meenakshi (Parvati) and Lord Sundareswarar (Shiva). 14 magnificent painted gopurams, over 33,000 sculptures. Named one of the seven wonders of India.',
      ...
      open_time: '5:00 AM', close_time: '10:00 PM',
    ...
    },
    {
      ...
      description: 'One of the most important Shakti Peethas in India. Adi Shankaracharya installed the Sri Chakra here to pacify the fierce form of Kamakshi. The gold-plated gopuram and the Adi Shankaracharya Mutt are here.',
    ...
    },
    {
      ...
      description: 'One of the most visited temples in Tamil Nadu. Among the highest-revenue temples in India. Thousands of devotees visit daily seeking blessings of the Mother Goddess. Known for its miraculous healing powers.',
    ...
    },
    {
      ...
      description: 'Located at the southernmost tip of India where the Arabian Sea, Bay of Bengal, and Indian Ocean converge. The nose ring of the Goddess is said to be so brilliant that it once misled ships. One of India\'s most scenic pilgrimage spots.',
      image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/Kanyakumari_Temple.jpg/480px-Kanyakumari_Temple.jpg',
      open_time: '4:30 AM', close_time: '8:30 PM',
    ...
    },
    {
      ...
      description: 'A beautiful modern temple right on the Bay of Bengal shore at Besant Nagar beach. Dedicated to the eight forms of Goddess Lakshmi. The multi-storeyed temple with the sea backdrop is stunning especially at sunset.',
    ...
    },
    {
      ...
      description: 'A highly revered village goddess temple near Virudhunagar. Angalamman is a form of the divine mother. Devotees from across Tamil Nadu visit during festivals. Known for fulfilling devotees\' wishes and granting prosperity.',
    ...
    // ══ FAMOUS GANESHA TEMPLES ════════════════════════════════════════════
    {
      ...
      description: 'A famous Ganesha temple perched atop the iconic 83-metre Rock Fort in Trichy. Reached by climbing 344 rock-cut steps through the rock itself. Offers a spectacular panoramic view of the city and the Cauvery river.',
    ...
    },
    {
      ...
      description: 'An ancient rock-cut cave temple dedicated to Lord Ganesha. The main idol is carved from a single rock and is believed to be over 1600 years old. Karpaga Vinayagar means the wish-fulfilling Ganesha.',
    ...
    // ══ FAMOUS VISHNU / DIVYA DESAM TEMPLES ══════════════════════════════
    {
      ...
      description: 'One of the 108 Divya Desams on the banks of the Cauvery river. The presiding deity is Trivikrama, who measured the universe in three strides. One of the most celebrated Vaishnava pilgrimage centers in Tamil Nadu.',
    ...
    },
    {
      ...
      description: 'One of the 108 Divya Desams in Kanchipuram. The presiding deity is worshipped as the messenger (Thoothar) of the Pandavas during the Mahabharata. One of the lesser-known but spiritually significant temples in Kanchipuram.',
      ...
      open_time: '7:00 AM', close_time: '7:30 PM',
      festivals: ['Vaikunta Ekadasi', 'Brahmotsavam'],
    ...
    // ══ HERITAGE / UNESCO SITES ═══════════════════════════════════════════
    {
      ...
      description: 'UNESCO World Heritage Site built by the Pallava king Narasimhavarman II in 700 CE. One of the oldest structural stone temples of South India, standing on the shores of the Bay of Bengal. Famous for intricate Pallava rock carvings.',
      ...
      open_time: '6:00 AM', close_time: '6:00 PM',
    ...
    },
    {
      ...
      description: 'UNESCO World Heritage monolithic rock-cut temples carved from a single rock each by Pallava king Narasimhavarman I (7th century CE). Named after the five Pandavas. An outstanding example of early Dravidian architecture.',
    ...
    // ══ NOTABLE REGIONAL TEMPLES ══════════════════════════════════════════
    {
      ...
      description: 'The Jalakandeswarar Temple inside Vellore Fort is a fine example of Vijayanagara architecture built in the 16th century. Rarely visited by tourists but architecturally stunning with intricate mandapams and the fort moat around it.',
    ...
    },
    {
      ...
      description: 'An important Murugan temple near Kumbakonam where Murugan blessed the sage Agastya. The temple is set on a small hill surrounded by greenery. A popular pilgrimage among devotees of Kumbakonam and surrounding districts.',
      ...
      open_time: '6:00 AM', close_time: '7:30 PM',
    ...
    },
    {
      ...
      description: 'One of the 108 Divya Desams and one of the largest Vishnu temples in Kumbakonam. The 11-storeyed rajagopuram is 45 metres tall — one of the tallest in South India. Carnatic composer Saint Tyagaraja was a devotee here.',
    ...
    },
    {
      ...
      description: 'One of the most important Shiva temples in Kumbakonam — which gets its name from this temple (Kumbam = pot). The sacred Mahamaham tank here draws millions every 12 years for the Mahamaham festival, one of the largest in India.',
    ...
    },
    {
      ...
      location: 'Thirunageswaram, Kumbakonam, Tamil Nadu',
      deity: 'Lord Shiva (Naganathaswamy) & Rahu (Snake planet)',
      description: 'One of the most unique temples in India — one of only a few temples in the world with a shrine dedicated to Rahu (the shadow planet). Thousands visit on Rahu Kalam to overcome the ill effects of Rahu in their horoscope.',
    ...
    },
    {
      ...
      description: 'The oldest stone temple in Kanchipuram, built in the early 8th century by the Pallava king Rajasimha. A masterpiece of early Dravidian architecture with beautiful sandstone carvings. One of the best preserved Pallava temples.',
    ...
    },
    {
      ...
      description: 'One of the six abodes of Lord Murugan. An ancient cave temple cut into a granite hill. Lord Murugan is believed to have married Devasena here. The cave shrine is a magnificent example of rock-cut temple architecture.',
      ...
      open_time: '5:30 AM', close_time: '8:30 PM',
    ...
    },
    {
      ...
      description: 'One of the 108 Divya Desams and a major Vishnu temple in the Cauvery delta. The temple has a massive sacred tank (Haridra Nadhi) and the annual festival Brahmotsavam draws thousands. Known as the Dakshina Dwaraka.',
    ...
    },
    {
      ...
      location: 'Madurai, Tamil Nadu',
      deity: 'Goddess Mariamman',
      description: 'Located adjacent to the famous Theppakulam tank in Madurai, this Mariamman temple is associated with the annual Teppam (float festival) of the Meenakshi temple. The float festival on the large tank is one of the most spectacular events in Madurai.',
    ...
    },
    {
      ...
      description: 'An ancient Shiva temple in Vedaranyam at the end of the Cauvery delta. Lord Shiva is believed to have recited the Vedas here as a deer (Mrig). The nearby Point Calimere wildlife sanctuary makes this a scenic pilgrimage.',
    ...
    },
    {
      ...
      deity: 'Lord Murugan',
      description: 'A well-known Murugan temple on the Cauvery delta coast. The temple is surrounded by beautiful sea and backwaters. Thousands of pilgrims from the Cauvery delta visit especially on Skanda Shashti and Thaipusam.',
    ...
    },
    {
      ...
      description: 'One of the 108 Divya Desams located in Chidambaram. The presiding deity Govindauja is worshipped in a sleeping (Sayanam) posture. The temple is associated with several Alvar saints who composed hymns here.',
    ...
    },
    {
      ...
      description: 'Birthplace of the great Shaivite saint Thirugnanasambandar (7th century CE). An important Shiva temple where the saint composed his first hymn as a child. The temple has remarkable Chola-period bronze sculptures.',
    ...
    },
    {
      ...
      description: 'A Murugan temple near the famous Courtallam waterfalls — known as the Spa of South India. Pilgrims take a holy bath in the medicinal waterfalls and visit the temple. The surrounding Western Ghats scenery is breathtaking.',
    ...
    },
    {
      ...
      description: 'One of the 108 Divya Desams located on the banks of the Thamirabarani river. The presiding deity is Lord Vishnu in a standing posture. The temple has ancient Pandya-era architecture and is an important Vaishnava pilgrimage center.',
    ...
    },
    {
      ...
      description: 'One of the 108 Divya Desams at the confluence of three rivers. Lord Vishnu is in a reclining posture. The temple complex is one of the largest Vishnu temples in South Tamil Nadu and has remarkable Pandya architecture.',
      image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/Thiruvattar_temple.jpg/480px-Thiruvattar_temple.jpg',
      open_time: '6:30 AM', close_time: '8:00 PM',
      festivals: ['Vaikunta Ekadasi', 'Brahmotsavam'],
    ...
    ...t,
    distance: 0,
    is_open: checkOpen(t.open_time, t.close_time),
    icon: '🛕',
  }));
}
...
async function getAllTemples() {
  ...
  const dbFormatted = dbTemples.map((t, index) => ({
    ...
    icon:        t.icon        || '🛕',
    distance:    0,
    open_time:   t.openTime    || '6:00 AM',
    close_time:  t.closeTime   || '8:00 PM',
    festivals:   t.festivals   || [],
    image_url:   t.imageUrl    || '',
    lat:         t.lat         || null,
    lon:         t.lon         || null,
    is_open:     t.isOpen !== undefined ? t.isOpen : true,
  }));
